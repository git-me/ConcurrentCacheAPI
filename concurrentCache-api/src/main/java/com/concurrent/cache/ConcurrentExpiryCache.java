...
public class ConcurrentExpiryCache implements ICache {
    ...
    public static class CacheBuilder {
        ...
        public ConcurrentExpiryCache build() {
            int capacityLimit = capacity == null ? ConstantValues.DEFAULT_CAPACITY : capacity;
            long expiryTime = this.expiryTime <= 0 ? ConstantValues.DEFAULT_EXPIRY_MILLIS : this.expiryTime;
